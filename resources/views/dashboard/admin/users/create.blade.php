...
<div class="container mx-auto px-6 py-8">
    <div class="bg-white rounded-lg shadow-xl p-8 max-w-2xl mx-auto">
        <h2 class="text-3xl font-extrabold text-gray-800 mb-6 text-center">Tambah Pengguna Baru</h2>
        ...
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- User Information --}}
            <div class="mb-6">
                <h3 class="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Informasi Pengguna</h3>
            ...
            {{-- Password --}}
            <div class="mb-6">
                <h3 class="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Kata Sandi</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Kata Sandi:</label>
                        <input type="password" name="password" id="password"
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-yellow-500" required>
                    </div>
                    <div>
            ...
            {{-- Alumni Profile Information (for Create) --}}
            <div class="mb-8">
                <h3 class="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Informasi Profil Alumni (Opsional)</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="alumni_code" class="block text-gray-700 text-sm font-bold mb-2">Kode Alumni:</label>
                        <input type="text" name="alumni_code" id="alumni_code"
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-yellow-500"
                               value="{{ old('alumni_code') }}">
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-yellow-500">{{ old('address') }}</textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="website_url" class="block text-gray-700 text-sm font-bold mb-2">URL Website:</label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="bio" id="bio" rows="4"
                                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-yellow-500">{{ old('bio') }}</textarea>
                    </div>
                    <div class="md:col-span-2">
                        <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Foto Profil:</label>
            ...
            <div class="flex items-center justify-between mt-8">
                <button type="submit"
                        class="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 px-6 rounded-full focus:outline-none focus:shadow-outline transition duration-300 transform hover:scale-105">
